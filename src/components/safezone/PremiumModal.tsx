...
const PremiumModal: React.FC<PremiumModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handlePayPal = () => {
    ...
    // After PayPal opens, we optimistically unlock (user confirms payment)
    setTimeout(() => {
      ...
      <div className="relative w-full max-w-md bg-[#0f1622] border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="relative bg-gradient-to-br from-cyan-500/20 to-blue-600/20 p-6 border-b border-white/10">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">SafeZone Premium</h2>
              <p className="text-slate-400 text-sm">Vollständiger Zugriff auf alle Features</p>
            </div>
          </div>
        ...
        <div className="px-6 pb-6 space-y-3">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3.5 rounded-xl font-bold text-[#003087] bg-[#FFC439] hover:bg-[#FFB800] transition flex items-center justify-center gap-2 text-sm"
          >
          ...
          <p className="text-center text-slate-500 text-xs">
            Nach der Zahlung wird dein Premium-Zugang sofort freigeschaltet
          </p>
        </div>
      </div>
    </div>
